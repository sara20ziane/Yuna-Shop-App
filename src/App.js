                  ...
                  >
                    ...
                    <div className="flex flex-col md:flex-row gap-2">
                      <input
                        ...
                        value={item.name}
                        onChange={(e) =>
                          setOrderItems(orderItems.map((oi) => oi.id === item.id ? { ...oi, name: e.target.value } : oi))
                        }
                      />
                      <div className="grid grid-cols-2 md:flex gap-2 w-full md:w-auto">
                        <input
                          ...
                          value={item.category}
                          onChange={(e) => setOrderItems(orderItems.map((oi) => oi.id === item.id ? { ...oi, category: e.target.value } : oi))}
                        />
                        <input
                          list="sizeList"
                          placeholder="Taille"
                          ...
                          value={item.size}
                          onChange={(e) => setOrderItems(orderItems.map((oi) => oi.id === item.id ? { ...oi, size: e.target.value } : oi))}
                        />
                        <input
                          list="colorList"
                          placeholder="Couleur"
                          ...
                          value={item.color}
                          onChange={(e) => setOrderItems(orderItems.map((oi) => oi.id === item.id ? { ...oi, color: e.target.value } : oi))}
                        />
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 md:flex flex-wrap md:flex-nowrap gap-2 items-center bg-gray-50/50 p-2 rounded-xl border border-gray-100">
                      <select
                        ...
                        onChange={(e) => setOrderItems(orderItems.map((oi) => oi.id === item.id ? { ...oi, arrivageId: e.target.value } : oi))}
                      >
                      ...
                      <select
                        ...
                        onChange={(e) => setOrderItems(orderItems.map((oi) => oi.id === item.id ? { ...oi, status: e.target.value } : oi))}
                      >
                      ...
                      <div className="col-span-1 flex items-center gap-1 bg-white px-2 py-2 md:py-1.5 rounded-lg shadow-sm border border-gray-100 md:w-24">
                        ...
                        <input
                          ...
                          onChange={(e) => setOrderItems(orderItems.map((oi) => oi.id === item.id ? { ...oi, priceAchatEuro: e.target.value } : oi))}
                        />
                      </div>
                      ...
                      <div className="col-span-2 flex items-center gap-2 mt-1 md:mt-0">
                        <div className="flex items-center gap-1 bg-[#F3E8E2]/40 px-3 py-2.5 md:py-1.5 rounded-lg shadow-sm border border-[#E8D5C4]/60 flex-1">
                          ...
                          <input
                            ...
                            onChange={(e) => setOrderItems(orderItems.map((oi) => oi.id === item.id ? { ...oi, priceVente: e.target.value } : oi))}
                          />
                        </div>
                        <button
                          type="button"
